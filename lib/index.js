...
var CalendarHeader = (0, _createReactClass2.default)({
  ...
  propTypes: {
    ...
    onDisplayMonth: _propTypes2.default.func
  },
  ...
  displayMonth: function displayMonth() {
    ...
    var month = this.props.monthLabels[this.props.displayDate.getMonth()];
...
exports.default = (0, _createReactClass2.default)({
  ...
  propTypes: {
    ...
    onDisplayMonth: _propTypes2.default.func,
    onFixInputDate: _propTypes2.default.func
  },
  ...
  fixInputDate: function fixInputDate() {
    var _this2 = this;
    ...
    var parsedDate = this.props.onFixInputDate(inputValue, this.parseInputDate);
    if (!parsedDate) {
      return;
    }
    ...
    setTimeout(function () {
      _this2.setState({
        ...
        inputValue: _this2.makeInputValueString(selectedDate)
      });
    }, 0);
  ...
  handleCalendarButtonClick: function handleCalendarButtonClick() {
  ...
  handleInputChange: function handleInputChange() {
    ...
    var _parseInputDate = this.parseInputDate(inputValue),
        year = _parseInputDate.year,
        month = _parseInputDate.month,
        day = _parseInputDate.day;
  ...
  parseInputDate: function parseInputDate(inputValue) {
    var month = void 0,
        day = void 0,
        year = void 0;
    if (this.props.dateFormat.match(/MM.DD.YYYY/)) {
  ...
  render: function render() {
    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement(
        _Overlay2.default,
        {
          ...
          container: function container() {
            return _this3.props.calendarContainer || _reactDom2.default.findDOMNode(_this3.refs.overlayContainer);
          },
          target: function target() {
            return _reactDom2.default.findDOMNode(_this3.refs.input);
          },
      ...
      _react2.default.createElement(
        ...
        { ref: 'calendarButton', onClick: this.handleCalendarButtonClick, style: { borderLeft: 0 } },
