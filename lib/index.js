...
exports.default = (0, _createReactClass2.default)({
  ...
  propTypes: {
    ...
    onDisplayMonth: _propTypes2.default.func,
    onParseInputDate: _propTypes2.default.func
  },
  ...
  handleInputChange: function handleInputChange() {
    ...
    var parsedDate = this.props.onParseInputDate ? this.props.onParseInputDate(inputValue, this.parseInputDate) : this.parseInputDate(inputValue);
    if (!parsedDate) {
